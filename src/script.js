...
gltfLoader.load("./models.glb", (gltf) => {
  ...
  // lOOP THROUGH POSITIONS and compare the number of vertices using the count property and update the maCount Accordingly
  ...
  for (const position of positions) {
    ...
    for (let i = 0; i < particles.maxCount; i++) {
      const i3 = i * 3
      //n the for(), as long as i3 is less than originalArray.length, take the values from originalArray and put them in newArray
